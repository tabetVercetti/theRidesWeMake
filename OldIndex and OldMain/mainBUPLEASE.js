...
let scene, camera, renderer, hlight, car, controls, orbitalControls, pointerLockControls, objectCenter ; //flyControls, ;
...
//     // if (controls === 'pointerLockControls') {} else {}
//     //     // if (paused) {
//     //     //     unpause();
//     //     //   } else {
//     //     //     pause();
...
//         moveLeft = false;
//         moveRight = false;
//     } else if (controls === 'flyControls') {c
...
function init() {
    ...
    instructions.addEventListener( 'click', function () {
        console.log('Object Height:',controls)
        if (pointerLockControls.enabled){pointerLockControls.lock();} else if (orbitalControls.enabled) {        
            instructions.style.display = 'none';
            blocker.style.display = 'none';} 
